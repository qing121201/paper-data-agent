...
- For `schematic-led composite`, draw a purpose-built scientific schematic in
  TikZ/SVG/PDF. Do not substitute Mermaid, PlantUML, a generic flowchart,
  mind-map, or editor screenshot.
